...
var taskInput=document.getElementById("todo-list__input");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    label.className='todo-list__items_task';

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="todo-list__items_task";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="todo-list__button_edit";

    deleteButton.className="todo-list__button_delete";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("todo-list__items_value");
    ...
    listItem.classList.toggle("todo-list__items_value");
};
